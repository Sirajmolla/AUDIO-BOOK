...
Label(root, text='SIRAJ TECH SOLUTION Project: Audiobook', font=('Comic Sans MS', 25)).pack(side=TOP, pady=10)
photo = PhotoImage(file=r"..\Audiobook-Project-with-Python--main\AudiobookGUICanvas.gif")
...
for num in range(0,pages):
    ...
    player.say(text)
    player.runAndWait()
engine.save_to_file(text,'Audiobook created by SIRAJ TECH SOLUTION.mp3')
engine.runAndWait()
